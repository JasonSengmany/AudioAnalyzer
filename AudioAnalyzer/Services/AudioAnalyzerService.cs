...
public class AudioAnalyzerService
{
    ...
    private readonly ILogger<AudioAnalyzerService> _logger;
    public List<Song> Songs { get; init; } = new();
    public AudioAnalyzerService(FeatureExtractionPipeline featureExtractionPipeline,
                                   IPersistenceService persistenceService,
                                   ILogger<AudioAnalyzerService> logger)
    {
